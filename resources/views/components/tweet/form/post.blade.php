        ...
        <form action="{{ route('tweet.create') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mt-1">
                <textarea
                    name="tweet"
                    rows="3"
                    class="focus:ring-blue-400 focus:border-blue-400 mt-1 ring-black w-full sm:text-sm border border-gray-300 rounded-md p-2"
            ...
            <!-- つぶやきに関するルールをCreateRequestで決めたので、それから外れればエラー表示 -->
            @error('tweet')
