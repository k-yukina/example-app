<div x-data="inputFormHandler()" class="my-2">
    <template x-for="(field, i) in fields" :key="i">
        <div class="w-full flex my-2">
            ...
            <!-- ここまで -->
            <button type="reset" @click="removeField(i)" class="p-2"> <!-- 画像投稿フィールド横のバツを押下したらフィールド削除 -->
    ...
    <!-- 画像を追加するための設定 -->
    <template x-if="fields.length < 4"> <!-- 画像追加フィールドが4つ未満であれば表示 -->
        <!-- ボタンがクリックされたら、inputForHandlerメソッドのaddFieldを実行する -->
